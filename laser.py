...
# RILEVAMENTO DINAMICO AUTOMATICO: Cerca i file nella cartella corrente del programma
CURRENT_DIR = os.path.dirname(os.path.abspath(__file__)) if '__file__' in locals() else os.getcwd()
logo_asi_path = os.path.join(CURRENT_DIR, "logo_asi.png")
logo_egeos_path = os.path.join(CURRENT_DIR, "logo_egeos.png")
...
with col1:
    if img_asi_stream: 
        ...
        st.markdown('<b style="color:red;">logo_asi.png non trovato nella cartella</b>', unsafe_allow_html=True)
with col2:
    if img_egeos_stream: 
        st.image(img_egeos_stream, width=130)
    else: 
        st.markdown('<b style="color:red;">logo_egeos.png non trovato nella cartella</b>', unsafe_allow_html=True)
